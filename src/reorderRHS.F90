...
contains
   ...
   subroutine ReorderRHSForY(ibeg, iend, F, F2)
      implicit none
      integer(kind=4), dimension(:), intent(in) :: ibeg
      integer(kind=4), dimension(:), intent(in) :: iend
      real(kind=8), dimension(:, :), intent(in) :: F
      real(kind=8), dimension(:, :), intent(out) :: F2
      ...
      do ix = ibeg(1), iend(1)
         do iy = ibeg(2), iend(2)
            do iz = ibeg(3), iend(3)
               ...
               ind2 = iy - ibeg(2) + 1
               ind13 = (ix - ibeg(1)) + (iz - ibeg(3))*(iend(1) - ibeg(1) + 1) + 1

               ind1 = ix - ibeg(1) + 1
               ind23 = (iy - ibeg(2)) + (iz - ibeg(3))*(iend(2) - ibeg(2) + 1) + 1
      ...
      do ix = ibeg(1), iend(1)
         do iy = ibeg(2), iend(2)
            do iz = ibeg(3), iend(3)
               ...
               ind3 = iz - ibeg(3) + 1
               ind12 = (ix - ibeg(1)) + (iy - ibeg(2))*(iend(1) - ibeg(1) + 1) + 1
