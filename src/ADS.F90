...
!> space to live on identical knot locations in every direction. The
...
!
!---------------------------------------------------------------------------
subroutine ValidateIGRMTimeStep(ads_test, ads_trial)
...
end subroutine ValidateIGRMTimeStep
...
!> @brief RHS derivative-state selector table.
      ...
      call ValidateIGRMTimeStep(ads_test, ads_trial)
...
!> path. It validates the iGRM mesh, prepares the 3D PR coefficient
!> tables, and executes the three directional substeps.
!
! Input:
! ------
!> @param[in] iter
...
!> validates the iGRM mesh, prepares directional Backward Euler
!> coefficient tables, and executes the three directional substeps.
!
! Input:
! ------
!> @param[in] iter
